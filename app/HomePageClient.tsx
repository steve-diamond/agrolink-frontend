...
export default function Home() {
  ...
  return (
    <main className="dos-homepage px-2 sm:px-0 py-4 sm:py-6 grid gap-4 sm:gap-6 w-full">
      {/* Single page-level h1 visible only to screen readers; visual branding is in NavBar */}
      <h1 className="sr-only">DOS Agrolink — Nigerian Agricultural Platform</h1>
      <FarmStocksTicker />
      <section className="dos-home-card">
        <section className="dos-hero" aria-label="Hero carousel">
          {/*
            aria-roledescription marks this as a carousel for screen readers.
            All slides are in the DOM simultaneously (CSS animation), so
            inactive ones are aria-hidden to prevent duplicate heading noise.
          */}
          <div
          ...
          >
            {localizedHeroSlides.map((slide, index) => (
              <article
                ...
                aria-label={`Slide ${index + 1} of ${localizedHeroSlides.length}: ${slide.title}`}
              ...
              >
                <Image
                  ...
                  aria-hidden={true}
                />
                <div className="dos-hero-overlay" aria-hidden="true" />
                <div className="dos-hero-content">
                  <div className="dos-hero-caption-shell">
                    {/* h2 because h1 is the sr-only page title above */}
                    <h2>{slide.title}</h2>
                    <p>{slide.subtitle}</p>
        ...
        <section className="dos-why" aria-labelledby="why-heading">
        ...
        <section className="dos-story" aria-labelledby="stories-heading">
          <Image src="/agropro/images/chose.jpg" alt="" fill className="dos-story-bg" sizes="100vw" aria-hidden={true} />
          <div className="dos-story-overlay" aria-hidden="true" />
          <div className="dos-story-content">
            <p className="dos-story-kicker" aria-hidden="true">Field Impact</p>
            <h2 id="stories-heading">Success Stories</h2>
            <figure className="dos-story-quote-card">
              <blockquote cite="#">&quot;DosAgrolink helped me double my yield and secure better buyers in one season.&quot;</blockquote>
              <figcaption>Adebayo, Ondo State &bull; Maize Farmer</figcaption>
            </figure>
        ...
        <section className="dos-partners" aria-labelledby="partners-heading">
          <div className="dos-partners-copy">
            <h2 id="partners-heading">Our Farmers & Partners</h2>
        ...
        <section className="dos-cta-strip" aria-labelledby="cta-heading">
          ...
          <ul className="dos-contact-row" aria-label="Contact information">
            <li><a href="tel:+2348129490467" aria-label="Call us: +234 812 949 0467"><span aria-hidden="true">☎</span> Call: 2348129490467</a></li>
            <li><a href="mailto:info@dosagrolink.com.ng" aria-label="Email us: info@dosagrolink.com.ng"><span aria-hidden="true">✉</span> info@dosagrolink.com.ng</a></li>
            <li><span aria-hidden="true">◉</span> SSL Secure</li>
            <li><span aria-hidden="true">◎</span> Certified</li>
          </ul>
        </section>
