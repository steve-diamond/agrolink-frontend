...
const CATEGORY_CONFIG: Record<MarketplaceCategoryValue, { icon: React.ReactNode; color: string; bg: string; border: string }> = {
...
const TRUST_STATS = [
  { icon: <FaStar className="text-amber-400" />, value: "4.8/5", label: "Avg Seller Rating" },
  { icon: <MdVerified className="text-blue-400" />, value: "2,400+", label: "Verified Sellers" },
  { icon: <FaShieldAlt className="text-green-400" />, value: "100%", label: "Secure Payments" },
  { icon: <FaTruck className="text-purple-400" />, value: "48hr", label: "Avg Delivery" },
];
